...
class SoftAttentionDrop(nn.Module): # learnable masking module
    def __init__(self, hidden_dim, temperature, drop_ratio):
        ...
        """
        self.temp = temperature # lower temperature -> sharper mask
        self.drop_ratio = drop_ratio # drop ratio of sharpen function
